...
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).Chart = e() }(this, (function() {
    ...
    function N(t) { return B(t) ? t : V(t).saturate(.5).darken(.1).hexString() }
    ...
    function Ht(t) { return Nt(t, -32768, 32767) }
        ...
        if (!(isNaN(d) || d <= 0)) {
            switch (t.beginPath(), c) {
                ...
                case "rectRounded":
                    ...
                    break;
                case "rect":
                        if (!h) { r = Math.SQRT1_2 * d, t.rect(i - r, n - r, 2 * r, 2 * r); break }u += Mt;
                case "rectRot":
                        s = Math.cos(u) * d,
                    a = Math.sin(u) * d,
                    t.moveTo(i - s, n - a),
    ...
    function re(t, e) {
        t._chartjs ? t._chartjs.listeners.push(e) : (Object.defineProperty(t, "_chartjs", { configurable: !0, enumerable: !1, value: { listeners: [e] } }), ae.forEach((e => {
    ...
    function le(t, e) {
        ...
        if (!i) return;
        const n = i.listeners,
            o = n.indexOf(e); - 1 !== o && n.splice(o, 1), n.length > 0 || (ae.forEach((e => { delete t[e] })), delete t._chartjs)
    }

    function ce(t) { const e = new Set; let i, n; for (i = 0, n = t.length; i < n; ++i) e.add(t[i]); if (e.size === n) return t; const o = []; return e.forEach((t => { o.push(t) })), o }

    function he(t) { let e = t.parentNode; return e && "[object ShadowRoot]" === e.toString() && (e = e.host), e }

    function de(t, e, i) { let n; return "string" == typeof t ? (n = parseInt(t, 10), -1 !== t.indexOf("%") && (n = n / 100 * e.parentNode[i])) : n = t, n }
    const ue = t => window.getComputedStyle(t, null);

    function fe(t, e) { return ue(t).getPropertyValue(e) }
    ...
    function me(t, e) {
        const { canvas: i, currentDevicePixelRatio: n } = e, o = ue(i), s = "border-box" === o.boxSizing, a = pe(o, "padding"), r = pe(o, "border", "width"), { x: l, y: c, box: h } = function(t, e) {
            const i = t.native || t,
                n = i.touches,
                o = n && n.length ? n[0] : i,
    ...
    function we(t, e) { return "native" in t ? { x: t.x, y: t.y } : me(t, e) }
    ...
    function Se(t, e, i, n) { const o = []; if (!Kt(e, t.chartArea, t._minPadding)) return o; return ke(t, i, e, (function(t, i, s) { t.inRange(e.x, e.y, n) && o.push({ element: t, datasetIndex: i, index: s }) }), !0), o }
    ...
    function Le(t) { return Re(t, { top: "y", right: "x", bottom: "y", left: "x" }) }

    function Ee(t) { return Re(t, ["topLeft", "topRight", "bottomLeft", "bottomRight"]) }

    function Ie(t) { const e = Le(t); return e.width = e.left + e.right, e.height = e.top + e.bottom, e }
    ...
    function Ve(t, e) { const { min: i, max: n } = t; return { min: i - Math.abs(Z(e, i)), max: n + Z(e, n) } }
    const Be = ["left", "top", "right", "bottom"];

    function We(t, e) { return t.filter((t => t.pos === e)) }

    function Ne(t, e) { return t.filter((t => -1 === Be.indexOf(t.pos) && t.box.axis === e)) }
    ...
    function je(t, e, i, n) { return Math.max(t[i], e[i]) + Math.max(t[n], e[n]) }

    function $e(t, e) { t.top = Math.max(t.top, e.top), t.left = Math.max(t.left, e.left), t.bottom = Math.max(t.bottom, e.bottom), t.right = Math.max(t.right, e.right) }
    ...
    var Ke = {
        ...
        update(t, e, i, n) {
            ...
            ! function(t, e) { let i, n, o; for (i = 0, n = t.length; i < n; ++i) o = t[i], o.horizontal ? (o.width = o.box.fullSize && e.availableWidth, o.height = e.hBoxMaxHeight) : (o.width = e.vBoxMaxWidth, o.height = o.box.fullSize && e.availableHeight) }(l.concat(c), d), Xe(r.fullSize, f, d), Xe(l, f, d), Xe(c, f, d) && Xe(l, f, d),
                function(t) {
                    const e = t.maxPadding;

                    function i(i) { const n = Math.max(e[i] - t[i], 0); return t[i] += n, n }
                    t.y += i("top"), t.x += i("left"), i("right"), i("bottom")
                }(f), qe(r.leftAndTop, f, d), f.x += f.w, f.y += f.h, qe(r.rightAndBottom, f, d), t.chartArea = { left: f.left, top: f.top, right: f.left + f.w, bottom: f.top + f.h, height: f.h, width: f.w }, J(r.chartArea, (e => {
                    const i = e.box;
    ...
    class Ze extends Ge { acquireContext(t) { return t && t.getContext && t.getContext("2d") || null } }
    ...
    function ei(t, e, i) { t.canvas.removeEventListener(e, i, ti) }
    ...
    function ai() {
        ...
        t !== si && (si = t, oi.forEach(((e, i) => { i.currentDevicePixelRatio !== t && e() })))
    }
    ...
    function ri(t, i, n) {
        ...
        return r.observe(s),
            function(t, e) { oi.size || window.addEventListener("resize", ai), oi.set(t, e) }(t, a), r
    }

    function li(t, e, i) { i && i.disconnect(), "resize" === e && function(t) { oi.delete(t), oi.size || window.removeEventListener("resize", ai) }(t) }
    ...
    function ci(t, i, n) {
        ...
        return function(t, e, i) { t.addEventListener(e, i, ti) }(o, i, s), s
    }
    class hi extends Ge {
        acquireContext(t, e) {
        ...
        getMaximumSize(t, e, i, n) { return be(t, e, i, n) }
        isAttached(t) { const e = he(t); return !(!e || !he(e)) }
    }
    ...
    const ui = t => 0 === t || 1 === t,
        ...
        pi = {
            ...
            easeInOutElastic(t) { const e = .1125; return ui(t) ? t : t < .5 ? .5 * fi(2 * t, e, .45) : .5 + .5 * gi(2 * t - 1, e, .45) },
    ...
    function ki(t, e) { const i = t && t.options.stacked; return i || void 0 === i && void 0 !== e.stack }

    function Si(t, e, i) { const n = t[e] || (t[e] = {}); return n[i] || (n[i] = {}) }
    ...
    function Di(t, e) { const i = t.scales; return Object.keys(i).filter((t => i[t].axis === e)).shift() }
    ...
    class Ti {
        ...
        includeOptions(t, e) { return !e || Oi(t) || this.chart._animationsDisabled }
        updateElement(t, e, i, n) { Oi(n) ? Object.assign(t, i) : this._resolveAnimations(e, n).update(t, i) }
        updateSharedOptions(t, e, i) { t && !Oi(e) && this._resolveAnimations(void 0, e).update(t, i) }
        _setStyle(t, e, i, n) {
            t.active = n;
    ...
    function Ei(t, e, i) { return function(t, e) { e = e || {}; const i = t + JSON.stringify(e); let n = Li.get(i); return n || (n = new Intl.NumberFormat(t, e), Li.set(i, n)), n }(e, i).format(t) }
    const Ii = {
        values: t => Y(t) ? t : "" + t,
        numeric(t, e, i) {
            if (0 === t) return "0";
        ...
        logarithmic(t, e, i) { if (0 === t) return "0"; const n = t / Math.pow(10, Math.floor(St(t))); return 1 === n || 2 === n || 5 === n ? Ii.numeric.call(this, t, e, i) : "" }
    };
    ...
    function zi(t, e) {
        ...
        if (s > 0) { let t, i; const n = s > 1 ? Math.round((r - a) / (s - 1)) : null; for (Vi(e, l, c, $(n) ? 0 : a - n, a), t = 0, i = s - 1; t < i; t++) Vi(e, l, c, o[t], o[t + 1]); return Vi(e, l, c, r, $(n) ? e.length : r + n), l }
        return Vi(e, l, c), l
    }
    ...
    function Hi(t) { return t.drawTicks ? t.tickLength : 0 }
    ...
    function $i(t, e, i) { let o = n(t); return (i && "right" !== e || !i && "right" === e) && (o = (t => "left" === t ? "right" : "right" === t ? "left" : t)(o)), o }
    class Yi extends Ri {
        ...
        fit() {
            ...
            if (a) {
                ...
                if (r ? (e.width = t.maxWidth, e.height = Hi(s) + a) : (e.height = t.maxHeight, e.width = Hi(s) + a), n.display && t.ticks.length) {
                    const { first: i, last: o, widest: s, highest: a } = t._getLabelSizes(), l = 2 * n.padding, c = Lt(t.labelRotation), h = Math.cos(c), d = Math.sin(c);
                    if (r) {
        ...
        _computeGridLineItems(t) {
            ...
            for (x = 0; x < c; ++x) {
                ...
                b = Ni(e, x, r), void 0 !== b && (_ = Ut(n, b, i), l ? y = w = k = P = _ : v = M = S = D = _, d.push({ tx1: y, ty1: v, tx2: w, ty2: M, x1: k, y1: S, x2: P, y2: D, width: i, color: o, borderDash: a, borderDashOffset: c, tickWidth: h, tickColor: u, tickBorderDash: f, tickBorderDashOffset: g }))
            }
        ...
        _computeLabelItems(t) {
            ...
            for (x = 0, b = r.length; x < b; ++x) {
                ...
                const i = D / 2,
                    ...
                    l = t.textStrokeColor,
                    h = t.textStrokeWidth;
                a ? (v = k, C = "top" === o ? "near" === c || 0 !== p ? -D * P + P / 2 : "center" === c ? -A.highest.height / 2 - i * P + P : -A.highest.height + P / 2 : "near" === c || 0 !== p ? P / 2 : "center" === c ? A.highest.height / 2 - i * P : A.highest.height - D * P, d && (C *= -1)) : (w = k, C = (1 - D) * P / 2), m.push({ rotation: p, label: y, font: S, color: n, strokeColor: l, strokeWidth: h, textOffset: C, textAlign: M, textBaseline: O, translation: [v, w] })
            }
            return m
        }
        _getXAxisLabelAlignment() { const { position: t, ticks: e } = this.options; if (-Lt(this.labelRotation)) return "top" === t ? "left" : "right"; let i = "center"; return "start" === e.align ? i = "left" : "end" === e.align && (i = "right"), i }
        ...
        drawGrid(t) {
            ...
            if (a) {
                const t = s.lineWidth,
                    i = e._borderValue;
                let n, r, l, c;
                e.isHorizontal() ? (n = Ut(o, e.left, a) - a / 2, r = Ut(o, e.right, t) + t / 2, l = c = i) : (l = Ut(o, e.top, a) - a / 2, c = Ut(o, e.bottom, t) + t / 2, n = r = i), h({ x: n, y: l }, { x: r, y: c }, { width: a, color: s.borderColor })
            }
        }
        drawLabels(t) {
            const e = this;
        ...
        drawTitle() {
            ...
            const { titleX: c, titleY: h, maxWidth: d, rotation: u } = function(t, e, i, n) { const { top: s, left: a, bottom: r, right: l } = t; let c, h, d, u = 0; return t.isHorizontal() ? (h = o(n, a, l), d = Bi(t, i, e), c = l - a) : (h = Bi(t, i, e), d = o(n, r, s), u = "left" === i ? -wt : wt), { titleX: h, titleY: d, maxWidth: c, rotation: u } }(this, l, e, r);
        ...
        _layers() {
            const t = this,
                ...
                n = e.grid && e.grid.z || 0;
            return t._isVisible() && i !== n && t.draw === Yi.prototype.draw ? [{ z: n, draw(e) { t.drawBackground(), t.drawGrid(e), t.drawTitle() } }, { z: i, draw(e) { t.drawLabels(e) } }] : [{ z: i, draw(e) { t.draw(e) } }]
        }
    ...
    function qi(t, e = { scriptable: !0, indexable: !0 }) { const { _scriptable: i = e.scriptable, _indexable: n = e.indexable, _allKeys: o = e.allKeys } = t; return { allKeys: o, scriptable: i, indexable: n, isScriptable: dt(i) ? i : () => i, isIndexable: dt(n) ? n : () => n } }
    const Ki = (t, e) => t ? t + ct(e) : e,
        Gi = (t, e) => U(e) && "adapters" !== t;

    function Zi(t, e, i) { let n = t[e]; return ht(n) || (n = i(), ht(n) && (t[e] = n)), n }

    function Qi(t, e, i) { return dt(t) ? t(e, i) : t }
    const Ji = (t, e) => !0 === t ? e : "string" == typeof t ? lt(e, t) : void 0;

    function tn(t, e, i, n) { for (const o of e) { const e = Ji(i, o); if (e) { t.add(e); const o = Qi(e._fallback, i, e); if (ht(o) && o !== i && o !== n) return o } else if (!1 === e && ht(n) && i !== n) return null } return !1 }
    ...
    function en(t, e, i, n) {
        ...
        r.add(n);
        let l = nn(r, a, i, s || i);
        return null !== l && ((!ht(s) || s === i || (l = nn(r, a, s, l), null !== l)) && Ui([...r], [""], o, s, (() => { const t = e._getTarget(); return i in t || (t[i] = {}), t[i] })))
    }

    function nn(t, e, i, n) { for (; i;) i = tn(t, e, i, n); return i }

    function on(t, e) { for (const i of e) { if (!i) continue; const e = i[t]; if (ht(e)) return e } }
    ...
    function cn(t) {
        ...
        for (o = 0; o < e; ++o)
            ...
            }! function(t, e, i) { const n = t.length; let o, s, a, r, l, c = rn(t, 0); for (let h = 0; h < n - 1; ++h) l = c, c = rn(t, h + 1), l && c && (At(e[h], 0, an) ? i[h] = i[h + 1] = 0 : (o = i[h] / e[h], s = i[h + 1] / e[h], r = Math.pow(o, 2) + Math.pow(s, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[h] = o * a * e[h], i[h + 1] = s * a * e[h]))) }(t, i, n),
        function(t, e) {
            const i = t.length;
            let n, o, s, a = rn(t, 0);
            for (let r = 0; r < i; ++r) {
    ...
    function hn(t, e, i) { return Math.max(Math.min(t, i), e) }

    function dn(t, e, i, n) {
        let o, s, a, r;
        if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) cn(t);
        else { let i = n ? t[t.length - 1] : t[0]; for (o = 0, s = t.length; o < s; ++o) a = t[o], r = ln(i, a, t[Math.min(o + 1, s - (n ? 0 : 1)) % s], e.tension), a.cp1x = r.previous.x, a.cp1y = r.previous.y, a.cp2x = r.next.x, a.cp2y = r.next.y, i = a }
        e.capBezierPoints && function(t, e) { let i, n, o, s, a, r = Kt(t[0], e); for (i = 0, n = t.length; i < n; ++i) a = s, s = r, r = i < n - 1 && Kt(t[i + 1], e), s && (o = t[i], a && (o.cp1x = hn(o.cp1x, e.left, e.right), o.cp1y = hn(o.cp1y, e.top, e.bottom)), r && (o.cp2x = hn(o.cp2x, e.left, e.right), o.cp2y = hn(o.cp2y, e.top, e.bottom))) }(t, i)
    }

    function un(t, e, i, n) { return { x: t.x + i * (e.x - t.x), y: t.y + i * (e.y - t.y) } }

    function fn(t, e, i, n) { return { x: t.x + i * (e.x - t.x), y: "middle" === n ? i < .5 ? t.y : e.y : "after" === n ? i < 1 ? t.y : e.y : i > 0 ? e.y : t.y } }
    ...
    function pn(t, e, i) { return t ? function(t, e) { return { x: i => t + t + e - i, setWidth(t) { e = t }, textAlign: t => "center" === t ? t : "right" === t ? "left" : "right", xPlus: (t, e) => t - e, leftForLtr: (t, e) => t - e } }(e, i) : { x: t => t, setWidth(t) {}, textAlign: t => t, xPlus: (t, e) => t + e, leftForLtr: (t, e) => t } }

    function mn(t, e) { let i, n; "ltr" !== e && "rtl" !== e || (i = t.canvas.style, n = [i.getPropertyValue("direction"), i.getPropertyPriority("direction")], i.setProperty("direction", e, "important"), t.prevTextDirection = n) }

    function xn(t, e) { void 0 !== e && (delete t.prevTextDirection, t.canvas.style.setProperty("direction", e[0], e[1])) }

    function bn(t) { return "angle" === t ? { between: Wt, compare: Vt, normalize: Bt } : { between: (t, e, i) => t >= Math.min(e, i) && t <= Math.max(i, e), compare: (t, e) => t - e, normalize: t => t } }

    function _n({ start: t, end: e, count: i, loop: n, style: o }) { return { start: t % i, end: e % i, loop: n && (e - t + 1) % i == 0, style: o } }

    function yn(t, e, i) {
        if (!i) return [t];
        const { property: n, start: o, end: s } = i, a = e.length, { compare: r, between: l, normalize: c } = bn(n), { start: h, end: d, loop: u, style: f } = function(t, e, i) {
        ...
        const y = () => b || l(o, x, p) && 0 !== r(o, x),
            v = () => !b || 0 === r(s, p) || l(s, x, p);
        for (let t = h, i = h; t <= d; ++t) m = e[t % a], m.skip || (p = c(m[n]), b = l(p, o, s), null === _ && y() && (_ = 0 === r(p, o) ? t : i), null !== _ && v() && (g.push(_n({ start: _, end: t, loop: u, count: a, style: f })), _ = null), i = t, x = p);
    ...
    var Cn = new class {
        constructor() { this.controllers = new Dn(Ti, "datasets", !0), this.elements = new Dn(Ri, "elements"), this.plugins = new Dn(Object, "plugins"), this.scales = new Dn(Yi, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements] }
    ...
    function Rn(t, e) { const i = mt.datasets[t] || {}; return ((e.datasets || {})[t] || {}).indexAxis || e.indexAxis || i.indexAxis || "x" }

    function Ln(t, e) { return "x" === t || "y" === t ? t : e.axis || ("top" === (i = e.position) || "bottom" === i ? "x" : "left" === i || "right" === i ? "y" : void 0) || t.charAt(0).toLowerCase(); var i }
    ...
    function In(t) { return (t = t || {}).datasets = t.datasets || [], t.labels = t.labels || [], t }
    const Fn = new Map,
        zn = new Set;

    function Vn(t, e) { let i = Fn.get(t); return i || (i = e(), Fn.set(t, i), zn.add(i)), i }
    const Bn = (t, e, i) => {
        const n = lt(e, i);
        void 0 !== n && t.add(n)
    };
    class Wn {
        constructor(t) { this._config = function(t) { return (t = t || {}).data = In(t.data), En(t), t }(t), this._scopeCache = new Map, this._resolverCache = new Map }
        get type() { return this._config.type }
        set type(t) { this._config.type = t }
        get data() { return this._config.data }
        set data(t) { this._config.data = In(t) }
        ...
        getOptionScopes(t, e, i) {
            ...
            if (a) return a;
            const r = new Set;
            e.forEach((e => { t && (r.add(t), e.forEach((e => Bn(r, t, e)))), e.forEach((t => Bn(r, n, t))), e.forEach((t => Bn(r, ut[o] || {}, t))), e.forEach((t => Bn(r, mt, t))), e.forEach((t => Bn(r, ft, t))) }));
            const l = [...r];
        ...
        createResolver(t, e, i = [""], n) { const { resolver: o } = Nn(this._resolverCache, t, i); return U(e) ? Xi(o, e, void 0, n) : o }
    }
    ...
    function Nn(t, e, i) {
        ...
        const o = i.join();
        let s = n.get(o);
        if (!s) { s = { resolver: Ui(e, i), subPrefixes: i.filter((t => !t.toLowerCase().includes("hover"))) }, n.set(o, s) }
        return s
    }
    const Hn = ["top", "bottom", "left", "right", "chartArea"];

    function jn(t, e) { return "top" === t || "bottom" === t || -1 === Hn.indexOf(t) && "x" === e }

    function $n(t, e) { return function(i, n) { return i[t] === n[t] ? i[e] - n[e] : i[t] - n[t] } }
    ...
    function Xn() { return "undefined" != typeof window && "undefined" != typeof document }

    function qn(t) { return Xn() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]), t && t.canvas && (t = t.canvas), t }
    const Kn = {},
        Gn = t => { const e = qn(t); return Object.values(Kn).filter((t => t.canvas === e)).pop() };
    class Zn {
        constructor(t, e) {
            const n = this;
        ...
        _initialize() { const t = this; return t.notifyPlugins("beforeInit"), t.options.responsive ? t.resize() : _e(t, t.options.devicePixelRatio), t.bindEvents(), t.notifyPlugins("afterInit"), t }
        _initializePlatform(t, e) { return e.platform ? new e.platform : !Xn() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? new Ze : new hi }
        ...
        buildOrUpdateScales() {
            ...
            i && (s = s.concat(Object.keys(i).map((t => {
                ...
                else { c = new(Cn.getScale(l))({ id: a, type: l, ctx: t.ctx, chart: t }), n[c.id] = c }
                c.init(s, e)
            })), J(o, ((t, e) => { t || delete n[e] })), J(n, (e => { Ke.configure(t, e, e.options), Ke.addBox(t, e) }))
        }
        ...
        update(t) {
            const e = this,
                i = e.config;
            i.update(), e._options = i.createResolver(i.chartOptionScopes(), e.getContext()), J(e.scales, (t => { Ke.removeBox(e, t) }));
            ...
            e._minPadding = s, e._updateLayout(s), n || J(o, (t => { t.reset() })), e._updateDatasets(t), e.notifyPlugins("afterUpdate", { mode: t }), e._layers.sort($n("z", "_idx")), e._lastEvent && e._eventHandler(e._lastEvent, !0), e.render()
        }
        _updateLayout(t) {
            const e = this;
        ...
        render() { const t = this;!1 !== t.notifyPlugins("beforeRender", { cancelable: !0 }) && (a.has(t) ? t.attached && !a.running(t) && a.start(t) : (t.draw(), Yn({ chart: t }))) }
        draw() {
            const t = this;
            let e;
        ...
        getElementsAtEventForMode(t, e, i, n) { const o = Ce.modes[e]; return "function" == typeof o ? o(this, t, i, n) : [] }
        getDatasetMeta(t) {
    ...
    function to() { throw new Error("This method is not implemented: either no adapter can be found or an incomplete integration was provided.") }
    Object.defineProperties(Zn, { defaults: { enumerable: Jn, value: mt }, instances: { enumerable: Jn, value: Kn }, overrides: { enumerable: Jn, value: ut }, registry: { enumerable: Jn, value: Cn }, version: { enumerable: Jn, value: "3.1.1" }, getChart: { enumerable: Jn, value: Gn }, register: { enumerable: Jn, value: (...t) => { Cn.add(...t), Qn() } }, unregister: { enumerable: Jn, value: (...t) => { Cn.remove(...t), Qn() } } });
    class eo {
        constructor(t) { this.options = t || {} }
        formats() { return to() }
        parse(t, e) { return to() }
        format(t, e) { return to() }
        add(t, e, i) { return to() }
        diff(t, e, i) { return to() }
        startOf(t, e, i) { return to() }
        endOf(t, e) { return to() }
    }
    eo.override = function(t) { Object.assign(eo.prototype, t) };
    var io = { _date: eo };
    ...
    function ao(t) { return t && void 0 !== t.barStart && void 0 !== t.barEnd }
    class ro extends Ti {
        parsePrimitiveData(t, e, i, n) { return so(t, e, i, n) }
        parseArrayData(t, e, i, n) { return so(t, e, i, n) }
        parseObjectData(t, e, i, n) { const { iScale: o, vScale: s } = t, { xAxisKey: a = "x", yAxisKey: r = "y" } = this._parsing, l = "x" === o.axis ? a : r, c = "x" === s.axis ? a : r, h = []; let d, u, f, g; for (d = i, u = i + n; d < u; ++d) g = e[d], f = {}, f[o.axis] = o.parse(lt(g, l), d), h.push(oo(lt(g, c), f, s, d)); return h }
        updateRangeFromParsed(t, e, i, n) {
    ...
    ro.id = "bar", ro.defaults = { datasetElementType: !1, dataElementType: "bar", categoryPercentage: .8, barPercentage: .9, grouped: !0, animations: { numbers: { type: "number", properties: ["x", "y", "base", "width", "height"] } } }, ro.overrides = { interaction: { mode: "index" }, scales: { _index_: { type: "category", offset: !0, grid: { offset: !0 } }, _value_: { type: "linear", beginAtZero: !0 } } };
    class lo extends Ti {
    ...
    lo.id = "bubble", lo.defaults = { datasetElementType: !1, dataElementType: "point", animations: { numbers: { type: "number", properties: ["x", "y", "borderWidth", "radius"] } } }, lo.overrides = { scales: { x: { type: "linear" }, y: { type: "linear" } }, plugins: { tooltip: { callbacks: { title: () => "" } } } };
    class co extends Ti {
        ...
        _getRotation() { return Lt(this.options.rotation - 90) }
        _getCircumference() { return Lt(this.options.circumference) }
        _getRotationExtents() {
            let t = bt,
                e = -bt;
            const i = this;
    ...
    class uo extends Ti {
        ...
        _computeAngle(t, e, i) { return this.chart.getDataVisibility(t) ? Lt(this.resolveDataElementOptions(t, e).angle || i) : 0 }
    }
    uo.id = "polarArea", uo.defaults = { dataElementType: "arc", animation: { animateRotate: !0, animateScale: !0 }, animations: { numbers: { type: "number", properties: ["x", "y", "startAngle", "endAngle", "innerRadius", "outerRadius"] } }, indexAxis: "r", startAngle: 0 }, uo.overrides = { aspectRatio: 1, plugins: { legend: { labels: { generateLabels(t) { const e = t.data; return e.labels.length && e.datasets.length ? e.labels.map(((e, i) => { const n = t.getDatasetMeta(0).controller.getStyle(i); return { text: e, fillStyle: n.backgroundColor, strokeStyle: n.borderColor, lineWidth: n.borderWidth, hidden: !t.getDataVisibility(i), index: i } })) : [] } }, onClick(t, e, i) { i.chart.toggleDataVisibility(e.index), i.chart.update() } }, tooltip: { callbacks: { title: () => "", label: t => t.chart.data.labels[t.dataIndex] + ": " + t.formattedValue } } }, scales: { r: { type: "radialLinear", angleLines: { display: !1 }, beginAtZero: !0, grid: { circular: !0 }, pointLabels: { display: !1 }, startAngle: 0 } } };
    class fo extends co {}
    ...
    go.id = "radar", go.defaults = { datasetElementType: "line", dataElementType: "point", indexAxis: "r", showLine: !0, elements: { line: { fill: "start" } } }, go.overrides = { aspectRatio: 1, scales: { r: { type: "radialLinear" } } };
    class po extends ho {}
    po.id = "scatter", po.defaults = { showLine: !1, fill: !1 }, po.overrides = { interaction: { mode: "point" }, plugins: { tooltip: { callbacks: { title: () => "", label: t => "(" + t.label + ", " + t.formattedValue + ")" } } }, scales: { x: { type: "linear" }, y: { type: "linear" } } };
    ...
    function _o(t, e, i, n) { return { x: i + t * Math.cos(e), y: n + t * Math.sin(e) } }

    function yo(t, e) {
        const { x: i, y: n, startAngle: o, endAngle: s, pixelMargin: a } = e, r = Math.max(e.outerRadius - a, 0), l = e.innerRadius + a, { outerStart: c, outerEnd: h, innerStart: d, innerEnd: u } = bo(e, l, r, s - o), f = r - c, g = r - h, p = o + c / f, m = s - h / g, x = l + d, b = l + u, _ = o + d / x, y = s - u / b;
    ...
    function vo(t, e) {
        ...
        i.borderWidth && (n ? (t.lineWidth = 2 * i.borderWidth, t.lineJoin = "round") : (t.lineWidth = i.borderWidth, t.lineJoin = "bevel"), e.fullCircles && function(t, e, i) { const { x: n, y: o, startAngle: s, endAngle: a, pixelMargin: r } = e, l = Math.max(e.outerRadius - r, 0), c = e.innerRadius + r; let h; for (i && (e.endAngle = e.startAngle + bt, xo(t, e), e.endAngle = a, e.endAngle === e.startAngle && (e.endAngle += bt, e.fullCircles--)), t.beginPath(), t.arc(n, o, c, s + bt, s, !0), h = 0; h < e.fullCircles; ++h) t.stroke(); for (t.beginPath(), t.arc(n, o, l, s, s + bt), h = 0; h < e.fullCircles; ++h) t.stroke() }(t, e, n), n && xo(t, e), yo(t, e), t.stroke())
    }
    class wo extends Ri {
        ...
        draw(t) {
            ...
            if (e.pixelMargin = "inner" === i.borderAlign ? .33 : 0, e.fullCircles = Math.floor(e.circumference / bt), !(0 === e.circumference || e.innerRadius < 0 || e.outerRadius < 0)) {
                ...
                t.fillStyle = i.backgroundColor, t.strokeStyle = i.borderColor,
                    function(t, e) {
                        if (e.fullCircles) { e.endAngle = e.startAngle + bt, yo(t, e); for (let i = 0; i < e.fullCircles; ++i) t.fill() }
    ...
    function Mo(t, e, i = e) { t.lineCap = K(i.borderCapStyle, e.borderCapStyle), t.setLineDash(K(i.borderDash, e.borderDash)), t.lineDashOffset = K(i.borderDashOffset, e.borderDashOffset), t.lineJoin = K(i.borderJoinStyle, e.borderJoinStyle), t.lineWidth = K(i.borderWidth, e.borderWidth), t.strokeStyle = K(i.borderColor, e.borderColor) }

    function ko(t, e, i) { t.lineTo(i.x, i.y) }
    ...
    function Po(t, e, i, n) { const { points: o, options: s } = e, { count: a, start: r, loop: l, ilen: c } = So(o, i, n), h = function(t) { return t.stepped ? Qt : t.tension ? Jt : ko }(s); let d, u, f, { move: g = !0, reverse: p } = n || {}; for (d = 0; d <= c; ++d) u = o[(r + (p ? c - d : d)) % a], u.skip || (g ? (t.moveTo(u.x, u.y), g = !1) : h(t, f, u, p, s.stepped), f = u); return l && (u = o[(r + (p ? c : 0)) % a], h(t, f, u, p, s.stepped)), !!l }
    ...
    function Ao(t, e, i, n) {
        ...
        }(t, e, i, n) : function(t, e, i, n) { const { segments: o, options: s } = e, a = Co(e); for (const r of o) Mo(t, s, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + n - 1 }) && t.closePath(), t.stroke() }(t, e, i, n)
    }
    class To extends Ri {
        ...
        get segments() { return this._segments || (this._segments = wn(this, this.options.segment)) }
        first() {
        ...
        interpolate(t, e) {
            ...
            if (!a.length) return;
            const r = [],
                l = function(t) { return t.stepped ? fn : t.tension ? gn : un }(n);
            let c, h;
        ...
        pathSegment(t, e, i) { return Co(this)(t, this, e, i) }
        path(t, e, i) {
            const n = this,
                o = n.segments,
                s = Co(n);
    ...
    class Lo extends Ri {
        ...
        inXRange(t, e) { return Ro(this, t, "x", e) }
        inYRange(t, e) { return Ro(this, t, "y", e) }
    ...
    function Eo(t, e) { const { x: i, y: n, base: o, width: s, height: a } = t.getProps(["x", "y", "base", "width", "height"], e); let r, l, c, h, d; return t.horizontal ? (d = a / 2, r = Math.min(i, o), l = Math.max(i, o), c = n - d, h = n + d) : (d = s / 2, r = i - d, l = i + d, c = Math.min(n, o), h = Math.max(n, o)), { left: r, top: c, right: l, bottom: h } }

    function Io(t) { let e = t.options.borderSkipped; const i = {}; return e ? (e = t.horizontal ? Fo(e, "left", "right", t.base > t.x) : Fo(e, "bottom", "top", t.base < t.y), i[e] = !0, i) : i }

    function Fo(t, e, i, n) { var o, s, a; return n ? (a = i, t = zo(t = (o = t) === (s = e) ? a : o === a ? s : o, i, e)) : t = zo(t, e, i), t }

    function zo(t, e, i) { return "start" === t ? e : "end" === t ? i : t }

    function Vo(t, e, i, n) { return t ? 0 : Math.max(Math.min(e, n), i) }
    ...
    function No(t, e) { t.rect(e.x, e.y, e.w, e.h) }
    Lo.id = "point", Lo.defaults = { borderWidth: 1, hitRadius: 1, hoverBorderWidth: 1, hoverRadius: 4, pointStyle: "circle", radius: 3, rotation: 0 }, Lo.defaultRoutes = { backgroundColor: "backgroundColor", borderColor: "borderColor" };
    class Ho extends Ri {
        ...
        inRange(t, e, i) { return Wo(this, t, e, i) }
        inXRange(t, e) { return Wo(this, t, null, e) }
        inYRange(t, e) { return Wo(this, null, t, e) }
    ...
    var Uo = {
        ...
        beforeElementsUpdate: (t, e, i) => {
            ...
            t.data.datasets.forEach(((e, o) => {
                ...
                let h, { start: d, count: u } = function(t, e) { const i = e.length; let n, o = 0; const { iScale: s } = t, { min: a, max: r, minDefined: l, maxDefined: c } = s.getUserBounds(); return l && (o = Nt(ne(e, s.axis, a).lo, 0, i - 1)), n = c ? Nt(ne(e, s.axis, r).hi + 1, o, i) - o : i - o, { start: o, count: n } }(r, l);
                if (u <= 4 * n) $o(e);
                else {
    ...
    function Go(t) {
        ...
        for (let t = 0; t < a.length; t++) { const e = a[t]; for (let t = e.start; t <= e.end; t++) Qo(s, r[t], l) }
    ...
    function is(t, e, i) { t.beginPath(), e.path(t), t.lineTo(e.last().x, i), t.lineTo(e.first().x, i), t.closePath(), t.clip() }
    ...
    function os(t, e, i, n) { return t && e ? n(t[i], e[i]) : t ? t[i] : e ? e[i] : 0 }

    function ss(t, e, i) { const { top: n, bottom: o } = e.chart.chartArea, { property: s, start: a, end: r } = i || {}; "x" === s && (t.beginPath(), t.rect(a, n, r - a, o - n), t.clip()) }
    ...
    function ls(t, e, i) {
        const n = function(t) { const { chart: e, fill: i, line: n } = t; if (X(i)) return function(t, e) { const i = t.getDatasetMeta(e); return i && t.isDatasetVisible(e) ? i.dataset : null }(e, i); if ("stack" === i) return Go(t); const o = Ko(t); return o instanceof qo ? o : ts(o, n) }(e),
        ...
        n && o.points.length && (Gt(t, i), function(t, e) {
            ...
            t.save(), "x" === l && s !== o && (is(t, n, a.top), rs(t, { line: i, target: n, color: o, scale: r, property: l }), t.restore(), t.save(), is(t, n, a.bottom)), rs(t, { line: i, target: n, color: s, scale: r, property: l }), t.restore()
    ...
    var cs = {
        ...
        afterDatasetsUpdate(t, e, i) {
            const n = (t.data.datasets || []).length,
                o = [];
            let s, a, r, l;
            for (a = 0; a < n; ++a) s = t.getDatasetMeta(a), r = s.dataset, l = null, r && r.options && r instanceof To && (l = { visible: t.isDatasetVisible(a), index: a, fill: Xo(r, a, n), chart: t, axis: s.controller.options.indexAxis, scale: s.vScale, line: r }), s.$filler = l, o.push(l);
    ...
    const hs = (t, e) => { let { boxHeight: i = e, boxWidth: n = e } = t; return t.usePointStyle && (i = Math.min(i, e), n = Math.min(n, e)), { boxWidth: n, boxHeight: i, itemHeight: Math.max(e, i) } };
    class ds extends Ri {
        ...
        _draw() {
            ...
            const { boxWidth: x, boxHeight: b, itemHeight: _ } = hs(l, g), y = t.isHorizontal(), v = this._computeTitleHeight();
            ...
            t.legendItems.forEach(((e, M) => {
                ...
                ! function(t, e, i) {
                    ...
                    function(t, e, i) { te(a, i.text, t, e + _ / 2, d, { strikethrough: i.hidden, textAlign: i.textAlign }) }(h.x(D), C, e), y ? m.x += P + f : m.y += w
    ...
    var us = {
        ...
        stop(t) { Ke.removeBox(t, t.legend), delete t.legend },
        beforeUpdate(t, e, i) {
            const n = t.legend;
    ...
    function xs(t) { return ("string" == typeof t || t instanceof String) && t.indexOf("\n") > -1 ? t.split("\n") : t }

    function bs(t, e) { const { element: i, datasetIndex: n, index: o } = e, s = t.getDatasetMeta(n).controller, { label: a, value: r } = s.getLabelAndValue(o); return { chart: t, label: a, parsed: s.getParsed(o), raw: t.data.datasets[n].data[o], formattedValue: r, dataset: s.getDataset(), dataIndex: o, datasetIndex: n, element: i } }
    ...
    function vs(t, e, i) { const n = e.yAlign || function(t, e) { const { y: i, height: n } = e; return i < n / 2 ? "top" : i > t.height - n / 2 ? "bottom" : "center" }(t, i); return { xAlign: e.xAlign || ys(t, e, i, n), yAlign: n } }

    function ws(t, e, i, n) { const { caretSize: o, caretPadding: s, cornerRadius: a } = t, { xAlign: r, yAlign: l } = i, c = o + s, h = a + s; let d = function(t, e) { let { x: i, width: n } = t; return "right" === e ? i -= n : "center" === e && (i -= n / 2), i }(e, r); const u = function(t, e, i) { let { y: n, height: o } = t; return "top" === e ? n += i : n -= "bottom" === e ? o + i : o / 2, n }(e, l, c); return "center" === l ? "left" === r ? d += c : "right" === r && (d -= c) : "left" === r ? d -= h : "right" === r && (d += h), { x: Nt(d, 0, n.width - e.width), y: Nt(u, 0, n.height - e.height) } }

    function Ms(t, e, i) { const n = Ie(i.padding); return "center" === e ? t.x + t.width / 2 : "right" === e ? t.x + t.width - n.right : t.x + n.left }

    function ks(t) { return ms([], xs(t)) }

    function Ss(t, e) { const i = e && e.dataset && e.dataset.tooltip && e.dataset.tooltip.callbacks; return i ? t.override(i) : t }
    class Ps extends Ri {
        ...
        getBeforeBody(t, e) { return ks(e.callbacks.beforeBody.apply(this, [t])) }
        getBody(t, e) {
            const i = this,
                { callbacks: n } = e,
                o = [];
        ...
        getAfterBody(t, e) { return ks(e.callbacks.afterBody.apply(this, [t])) }
        getFooter(t, e) {
            const i = this,
                { callbacks: n } = e,
        ...
        drawTitle(t, e, i) {
            const n = this,
                ...
                s = o.length;
            let a, r, l;
            if (s) { const c = pn(i.rtl, n.x, n.width); for (t.x = Ms(n, i.titleAlign, i), e.textAlign = c.textAlign(i.titleAlign), e.textBaseline = "middle", a = Fe(i.titleFont), r = i.titleSpacing, e.fillStyle = i.titleColor, e.font = a.string, l = 0; l < s; ++l) e.fillText(o[l], c.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + r, l + 1 === s && (t.y += i.titleMarginBottom - r) }
        }
        ...
        drawFooter(t, e, i) {
            const n = this,
                ...
                s = o.length;
            let a, r;
            if (s) { const l = pn(i.rtl, n.x, n.width); for (t.x = Ms(n, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = l.textAlign(i.footerAlign), e.textBaseline = "middle", a = Fe(i.footerFont), e.fillStyle = i.footerColor, e.font = a.string, r = 0; r < s; ++r) e.fillText(o[r], l.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + i.footerSpacing }
        }
    ...
    function Os(t, e, i) { const n = t.indexOf(e); if (-1 === n) return ((t, e, i) => "string" == typeof e ? t.push(e) - 1 : isNaN(e) ? null : i)(t, e, i); return n !== t.lastIndexOf(e) ? i : n }
    class As extends Yi {
        constructor(t) { super(t), this._startValue = void 0, this._valueRange = 0 }
        parse(t, e) { if ($(t)) return null; const i = this.getLabels(); return ((t, e) => null === t ? null : Nt(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : Os(i, t, K(e, t)), i.length - 1) }
        determineDataLimits() {
            const t = this,
    ...
    class Ts extends Yi {
        ...
        getLabelForValue(t) { return Ei(t, this.chart.options.locale) }
    }
    class Rs extends Ts {
        determineDataLimits() {
            const t = this,
    ...
    function Ls(t) { return 1 === t / Math.pow(10, Math.floor(St(t))) }
    ...
    class Es extends Yi {
        ...
        buildTicks() {
            const t = this,
                ...
                i = function(t, e) {
                    ...
                    do { o.push({ value: s, major: Ls(s) }), ++r, 10 === r && (r = 1, ++a, l = a >= 0 ? 1 : l), s = Math.round(r * Math.pow(10, a) * l) / l } while (a < i || a === i && r < n);
                    const c = q(t.max, s);
        ...
        getLabelForValue(t) { return void 0 === t ? "0" : Ei(t, this.chart.options.locale) }
        configure() {
            const t = this,
                e = t.min;
    ...
    function Is(t) { const e = t.ticks; if (e.display && t.display) { const t = Ie(e.backdropPadding); return K(e.font && e.font.size, mt.font.size) + t.height } return 0 }

    function Fs(t, e, i, n, o) { return t === n || t === o ? { start: e - i / 2, end: e + i / 2 } : t < n || t > o ? { start: e - i, end: e } : { start: e, end: e + i } }

    function zs(t) { return 0 === t || 180 === t ? "center" : t < 180 ? "left" : "right" }

    function Vs(t, e, i) { 90 === t || 270 === t ? i.y -= e.h / 2 : (t > 270 || t < 90) && (i.y -= e.h) }
    ...
    class Ns extends Ts {
        ...
        computeTickLimit() { return Math.ceil(this.drawingArea / Is(this.options)) }
        generateTickLabels(t) {
            const e = this;
            Ts.prototype.generateTickLabels.call(e, t), e._pointLabels = e.getLabels().map(((t, i) => { const n = Q(e.options.pointLabels.callback, [t, i], e); return n || 0 === n ? n : "" }))
        }
        fit() {
            const t = this,
                e = t.options;
        ...
        getIndexAngle(t) { return Bt(t * (bt / this.getLabels().length) + Lt(this.options.startAngle || 0)) }
    ...
    Ns.id = "radialLinear", Ns.defaults = { display: !0, animate: !0, position: "chartArea", angleLines: { display: !0, lineWidth: 1, borderDash: [], borderDashOffset: 0 }, grid: { circular: !1 }, startAngle: 0, ticks: { showLabelBackdrop: !0, backdropColor: "rgba(255,255,255,0.75)", backdropPadding: 2, callback: Fi.formatters.numeric }, pointLabels: { backdropColor: void 0, backdropPadding: 2, display: !0, font: { size: 10 }, callback: t => t, padding: 5 } }, Ns.defaultRoutes = { "angleLines.color": "borderColor", "pointLabels.color": "color", "ticks.color": "color" }, Ns.descriptors = { angleLines: { _fallback: "grid" } };
    const Hs = { millisecond: { common: !0, size: 1, steps: 1e3 }, second: { common: !0, size: 1e3, steps: 60 }, minute: { common: !0, size: 6e4, steps: 60 }, hour: { common: !0, size: 36e5, steps: 24 }, day: { common: !0, size: 864e5, steps: 30 }, week: { common: !1, size: 6048e5, steps: 4 }, month: { common: !0, size: 2628e6, steps: 12 }, quarter: { common: !1, size: 7884e6, steps: 4 }, year: { common: !0, size: 3154e7 } },
        js = Object.keys(Hs);
    ...
    class Ks extends Yi {
        ...
        parse(t, e) { return void 0 === t ? null : Ys(this, t) }
        ...
        buildTicks() {
            ...
            const s = t.min,
                a = se(o, s, t.max);
            return t._unit = i.unit || (n.autoSkip ? Us(i.minUnit, t.min, t.max, t._getLabelCapacity(s)) : function(t, e, i, n, o) { for (let s = js.length - 1; s >= js.indexOf(i); s--) { const i = js[s]; if (Hs[i].common && t._adapter.diff(o, n, i) >= e - 1) return i } return js[i ? js.indexOf(i) : 0] }(t, a.length, i.minUnit, t.min, t.max)), t._majorUnit = n.major.enabled && "year" !== t._unit ? function(t) {
        ...
        normalize(t) { return ce(t.sort($s)) }
    }
    ...
    class Zs extends Ks {
        ...
        getDecimalForValue(t) { return Gs(this._table, t) / this._maxIndex }
        getValueForPixel(t) {
            const e = this,
                i = e._offsets,
                n = e.getDecimalForPixel(t) / i.factor - i.end;
