                    ...
                    @foreach ($user as $key => $item   )
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route($modul.'.edit', $item->id) }}" title="{{ $item->name }}" class="btn btn-sm font-sm rounded btn-brand btn-modal"><i class="material-icons md-edit"></i> Edit</a>
        ...
        <div class="modal-body">
            <form action="{{ route($modul.'.store') }}" method="POST">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="name" class="form-control" placeholder="Tulis Username" />
                    </div>
                </div>
                <div class="row mb-4">
